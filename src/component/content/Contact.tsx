         ...
         <div className="arlo_tm_section" id="contact">
                            ...
                            <div className="arlo_tm_footer_contact_wrapper_all">
                                    ...
                                    <div className="container">
                                        <div className="leftbox">
                                            ...
                                            <div className="short_info_wrap">
                                                <ul>
                                                    <li><p><label>Email:</label><span><a href="nguyenchihuong232@gmail.com" target="_blank">nguyenchihuong232@gmail.com</a></span></p></li>
                                                    <li><p><label>Website:</label><span><a href="https://github.com/ngchihuong/Udemy_Portfolio_Typescript" target="_blank">www.github.com</a></span></p></li>
                                                </ul>
                                            </div>
                                        </div>
                                ...
                                <div className="arlo_tm_footer_wrap">
                                    <div className="container">
                                        <p>&copy; Copyright 2024 by Nguyen Chi Huong. All Rights are Reserved.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
